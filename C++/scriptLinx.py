...
class RunScript:
    def __init__(self, args, filename=""):
        ...
        lib_path = "/home/shivam/ssd_data/project/llamaC++/openBlasInclude/lib"

        self.args = [
            "g++", "-std=c++23", self.filename,
            "-I/home/shivam/ssd_data/project/llamaC++/openBlasInclude/include",
            f"-L{lib_path}",
            "-lopenblas",
            f"-Wl,-rpath,{lib_path}"
        ] + self.GetAllDir() + ["-o", "main"] + args
